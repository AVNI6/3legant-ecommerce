...
// const MapPage = () => {
//     return (
//         <div className="w-full pb-12 px-5 sm:px-10 md:px-10 lg:px-30">
//             <div className="max-w-7xl mx-auto">
//                 <div className="flex flex-col-reverse lg:flex-row gap-10">
//                     <div className="flex-1">
//                         <form className="flex flex-col gap-6">
//                             <div>
//                                 <label className="text-sm font-semibold text-[#6C7275]">
//                                     FULL NAME
//                                 </label>
//                                 <input type="text" placeholder="Your Name"  className="w-full mt-2 px-4 py-3 border border-[#CBCBCB] rounded-md" />
//                             </div>
//                             <div>
//                                 <label className="text-sm font-semibold text-[#6C7275]">
//                                     EMAIL ADDRESS
//                                 </label>
//                                 <input type="email" placeholder="Your Email" className="w-full mt-2 px-4 py-3 border border-[#CBCBCB] rounded-md" />
//                             </div>
//                             <div>
//                                 <label className="text-sm font-semibold text-[#6C7275]">
//                                     MESSAGE
//                                 </label>
//                                 <textarea rows={5} placeholder="Your message" className="w-full mt-2 px-4 py-3 border border-[#CBCBCB] rounded-md" />
//                             </div>
//                             <button type="submit" className="bg-black text-white text-[16px] px-[40px] py-3 rounded-[8px] w-fit hover:bg-gray-800 transition" >
//                                 Send Message
//                             </button>
//                         </form>
//                     </div>
